...
| KubeServer | `yunionio/kubecomps` tag `v4.0.3`, commit `eb381ed38b587e2cabd081c69a0e6b0aa04a5360`, built natively on RISC-V with the three pinned kubespray submodule archives recorded in `versions.env`; its CGO/Ceph link uses Alpine `lld20` `20.1.8-r0` because GNU ld 2.44 crashes on the generated RISC-V relocation stream |
